...
| lerobot_composition | paused after qualified video seed | 2026-09-11 | A locked one-frame v3 video seed reaches metadata, a Parquet row, a resolved H.264 MP4, PyAV float32 CHW decoding, task lookup and a one-worker DataLoader; missing, truncated and late-timestamp controls fail at exact earlier stages. | No compute. Review R8 and make a new lifecycle decision before any mutation work; known video/timestamp cases remain regression and dedup controls. |
