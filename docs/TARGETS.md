...
| lerobot_composition | paused after qualified M0 | 2026-09-10 | Source confirms metadata→episode→Parquet row→task/video→training DataLoader composition. No local environment, seed or runtime reach exists yet. | No compute. Approve a separate locked build-and-seed brief; prove a minimal no-video composed sample before video or mutation work. |
